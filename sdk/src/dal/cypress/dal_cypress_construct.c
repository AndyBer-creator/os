...
void dal_cypress_construct_serdesConfig_init(uint32 unit)
{
    ...
    int32   ret;
    uint32  polarity_reg[] = {CYPRESS_SDS0_1_XSG0r, CYPRESS_SDS0_1_XSG1r,
                              CYPRESS_SDS2_3_XSG0r, CYPRESS_SDS2_3_XSG1r,
                              CYPRESS_SDS4_5_XSG0r, CYPRESS_SDS4_5_XSG1r,
                              CYPRESS_SDS6_7_XSG0r, CYPRESS_SDS6_7_XSG1r,
                              CYPRESS_SDS8_9_XSG0r, CYPRESS_SDS8_9_XSG1r,
                              CYPRESS_SDS10_11_XSG0r, CYPRESS_SDS10_11_XSG1r,
                              CYPRESS_SDS12_13_XSG0r, CYPRESS_SDS12_13_XSG1r};
    int i, macId;
    ...
    HWP_SDS_TRAVS(unit, sdsId)
    {
        if (SERDES_POLARITY_CHANGE == HWP_SDS_RX_POLARITY(unit, sdsId))
            reg_field_write(unit, polarity_reg[sdsId], CYPRESS_SR0_INV_HSIf, &val);

        if (SERDES_POLARITY_CHANGE == HWP_SDS_TX_POLARITY(unit, sdsId))
            reg_field_write(unit, polarity_reg[sdsId], CYPRESS_SR0_INV_HSOf, &val);
    }
