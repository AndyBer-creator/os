 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8382M_INTPHY_8218B_8214FC_YFD demo board.
 *
 * Feature : RTL8382M_INTPHY_8218B_8214FC_YFD demo board database
 *
 */

static hwp_swDescp_t rtl8382m_intphy_8218b_8214fc_yfd_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 24,       .led_c = HWP_NONE,       .led_f = 1, .led_layout = SINGLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 25,       .led_c = HWP_NONE,       .led_f = 1, .led_layout = SINGLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 26,       .led_c = HWP_NONE,       .led_f = 1, .led_layout = SINGLE_SET,},
        { .mac_id = 27, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 27,       .led_c = HWP_NONE,       .led_f = 1, .led_layout = SINGLE_SET,},
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8382m_intphy_8218b_8214fc_yfd = {

    .identifier.name        = "RTL8382M_INTPHY_8218B_8214FC_YFD",
    .identifier.id          = HWP_RTL8382M_INTPHY_8218B_8214FC_YFD,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8382m_intphy_8218b_8214fc_yfd_swDescp,
    }
