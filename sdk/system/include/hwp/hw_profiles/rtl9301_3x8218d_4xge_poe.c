 ...
 * 24 + 4*10G mode
 */
static hwp_swDescp_t rtl9301_3x8218d_4xge_poe_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_SERDES,  .sds_idx = 4,       .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE, .led_c = HWP_NONE,        .led_f = 3,       .led_layout = SINGLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_SERDES,  .sds_idx = 5,       .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE, .led_c = HWP_NONE,        .led_f = 3,       .led_layout = SINGLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_SERDES,  .sds_idx = 6,       .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE, .led_c = HWP_NONE,        .led_f = 3,       .led_layout = SINGLE_SET,},
        { .mac_id = 27, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_SERDES,  .sds_idx = 7,       .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE, .led_c = HWP_NONE,        .led_f = 3,       .led_layout = SINGLE_SET,},
    ...
    .led.descp = {
        ...
        .led_definition_set[0].led[0] = 0xBA0,       /* 1000/100/10 Mbps link  */
        .led_definition_set[0].led[1] = 0xBA0,       /* 1000/100/10 Mbps act*/
        .led_definition_set[0].led[2] = HWP_LED_END,      /* None */

        .led_definition_set[3].led[0] = 0xBAB,        /* 1000 Mbps/10G link  */
        .led_definition_set[3].led[1] = 0xBAB,        /* 1000 Mbps/10G act */
    ...
    .serdes.descp = {
        ...
        [4] = { .sds_id = 4, .mode = RTK_MII_10GR,    .rx_polarity = SERDES_POLARITY_CHANGE, .tx_polarity = SERDES_POLARITY_NORMAL },
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9301_3x8218d_4xge_poe = {

    .identifier.name        = "RTL9301_3x8218D_4XGE_POE",
    .identifier.id          = HWP_RTL9301_3x8218D_4XGE_POE,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9301_3x8218d_4xge_poe_swDescp,
    }
