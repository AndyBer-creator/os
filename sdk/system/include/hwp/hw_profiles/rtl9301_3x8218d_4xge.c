...
static hwp_swDescp_t rtl9301_3x8218d_4xge_swDescp = {
    ...
    .led.descp = {
        ...
        .led_definition_set[0].led[0] = 0x0BA0,        /* 1000/100/10 Mbps link/act */
        .led_definition_set[0].led[1] = 0x0220,        /* 1000 link */
        .led_definition_set[0].led[2] = HWP_LED_END,      /* None */  
        
        .led_definition_set[3].led[0] = 0x0AAB,        /* 100/1000/2500/5000 Mbps/10G link/act */
        .led_definition_set[3].led[1] = 0x0201,        /* 10G link */
