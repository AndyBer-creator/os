 ...
 *
 */
static hwp_swDescp_t rtl8393m_6x8218B_demo_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8393m_6x8218b_demo = {

    .identifier.name        = "RTL8393M_6x8218b_DEMO",
    .identifier.id          = HWP_RTL8393M_6x8218B,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8393m_6x8218B_demo_swDescp,
    }
