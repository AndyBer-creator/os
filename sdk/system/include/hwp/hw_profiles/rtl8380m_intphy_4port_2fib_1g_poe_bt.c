...
static hwp_swDescp_t rtl8380m_intphy_4port_2fib_1g_poe_bt_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_SERDES, .sds_idx = 4,        .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE, .led_c = HWP_NONE, .led_f = 0,        .led_layout = SINGLE_SET, },
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_SERDES, .sds_idx = 5,        .phy_idx = HWP_NONE, .smi = HWP_NONE, .phy_addr = HWP_NONE, .led_c = HWP_NONE, .led_f = 0,        .led_layout = SINGLE_SET, },
    ...
    .led.descp = {
        ...
        .led_definition_set[0].led[2] = 0x0,          /* link/act */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8380m_intphy_4port_2fib_1g_poe_bt = {

    .identifier.name        = "RTL8380M_INTPHY_4PORT_2FIB_1G_POE_BT",
    .identifier.id          = HWP_RTL8380M_INTPHY_4PORT_2FIB_1G_POE_BT,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8380m_intphy_4port_2fib_1g_poe_bt_swDescp,
    }
