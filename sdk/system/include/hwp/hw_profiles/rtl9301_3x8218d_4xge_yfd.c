 ...
 * 24 + 4*10G mode
 */
static hwp_swDescp_t rtl9301_3x8218d_4xge_yfd_swDescp = {
    ...
    .led.descp = {
        ...
        .led_definition_set[0].led[0] = 0x0B80,       /* 100/10 Mbps link  */
        .led_definition_set[0].led[1] = 0x0A20,       /* 1000 Mbps act*/
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9301_3x8218d_4xge_yfd = {

    .identifier.name        = "RTL9301_3x8218D_4XGE_YFD",
    .identifier.id          = HWP_RTL9301_3x8218D_4XGE_YFD,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9301_3x8218d_4xge_yfd_swDescp,
    }
