...
static hwp_swDescp_t rtl8380m_intphy_4port_2fib_1g_yfd_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8380m_intphy_4port_2fib_1g_yfd = {

    .identifier.name        = "RTL8380M_INTPHY_4PORT_2FIB_1G_YFD",
    .identifier.id          = HWP_RTL8380M_INTPHY_4PORT_2FIB_1G_YFD,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8380m_intphy_4port_2fib_1g_yfd_swDescp,
    }
};
