 ...
 * 48 + 6*10G mode
 */
static hwp_swDescp_t rtl9311_6x8218d_6xge_yfd_swDescp =
{
    ...
    .led.descp = {
        ...
        .led_definition_set[2].led[0] = 0x0A20,
        .led_definition_set[2].led[1] = 0x0B80,
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311_6x8218d_6xge_yfd = {
    .identifier.name        = "RTL9311_6x8218D_6XGE_YFD",
    .identifier.id          = HWP_RTL9311_6x8218D_6XGE_YFD,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9311_6x8218d_6xge_yfd_swDescp,
    }
};
