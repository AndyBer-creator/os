 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8382M_INTPHY_8218B_8214FC_POE_BT demo board.
 *
 * Feature : RTL8382M_INTPHY_8218B_8214FC_POE_BT demo board database
 *
 */

static hwp_swDescp_t rtl8382m_intphy_8218b_8214fc_poe_bt_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 24,       .led_c = 1,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 25,       .led_c = 1,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 26,       .led_c = 1,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
        { .mac_id = 27, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 27,       .led_c = 1,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
    ...
    .led.descp = {
        ...
        .led_definition_set[0].led[0] = 0x0, /* Link/Act 5b 00000 Link, Activity Indicator */
        .led_definition_set[0].led[1] = 0x7, /* Link/Act 5b 00000 Link, Activity Indicator */
        .led_definition_set[0].led[2] = 0x7, /* Link/Act 5b 00000 Link, Activity Indicator */
        .led_definition_set[0].led[3] = HWP_LED_END,
        
        /* LED definition - set 1 */
        .led_definition_set[1].led[0] = 0x0, /* Link 5b 00001 Link Indicator */
        .led_definition_set[1].led[1] = 0x7, /* Act 5b 00010 Activity Indicator */
        .led_definition_set[1].led[2] = 0x7, /* Link/Act 5b 00000 Link, Activity Indicator */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8382m_intphy_8218b_8214fc_poe_bt = {

    .identifier.name        = "RTL8382M_INTPHY_8218B_8214FC_POE_BT",
    .identifier.id          = HWP_RTL8382M_INTPHY_8218B_8214FC_POE_BT,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8382m_intphy_8218b_8214fc_poe_bt_swDescp,
    }
