 ...
 */
#ifdef CONFIG_SDK_HW_PROFILE_PROBE_GPIO
#define BOARD_PROBE_PIN_NUMBER              4
 ...
 */
    ...
    typedef struct board_gpioValue_to_boardId_e
    {
        int                        gpioBoardidValue;     /*用户定义的board id*/
        int                        hw_profileBoardid;    /*hw profile 里面配置的demo板ID*/
    }board_gpioValue_to_boardId_t;
#endif
