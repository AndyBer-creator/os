...
struct rtk_partition_info_t rtk_flash_partition_size[5] = {
     ...
     [3] = {
         ...
         .jffs2_log_size = (UNIT_SIZE*16),
         .kernel_offset = (0x00300000U),
         .kernel_size = (0x03C00000U),
         .kernel2_offset = (0x0U),
         .kernel2_size = (0x0U),
         .oeminfo_offset = (0x03f00000U),
         .oeminfo_size = (UNIT_SIZE*16)
#endif
      },
      [4] = {
          ...
          .jffs2_log_size = (UNIT_SIZE*16),
          .kernel_offset = (0x00300000U),
          .kernel_size = (0x03d80000U),
          .kernel2_offset = (0x04080000U),
          .kernel2_size = (0x03d80000U),
          .oeminfo_offset = (0x07E00000U),
          .oeminfo_size = (UNIT_SIZE*32)
#else
          .loader_offset = (0x00000000U),
          .loader_size = (UNIT_SIZE*14),
          .bdinfo_offset = (0x000e0000U),
          ...
          .jffs2_log_size = (UNIT_SIZE*16),
          .kernel_offset = (0x00300000U),
          .kernel_size = (0x07C00000U),
          .kernel2_offset = (0x0U),
          .kernel2_size = (0x0U),
          .oeminfo_offset = (0x07f00000U),
          .oeminfo_size = (UNIT_SIZE*16)
#endif
     },
 };
...
#endif
            case FLASH_INDEX_OEMINFO:           /* OEMINFO */
                rtk_sdk_parts[partition_idx].offset = rtk_flash_partition_size[size_idx].oeminfo_offset;
                rtk_sdk_parts[partition_idx].size = rtk_flash_partition_size[size_idx].oeminfo_size;
                break;
            default:
                break;
        }
