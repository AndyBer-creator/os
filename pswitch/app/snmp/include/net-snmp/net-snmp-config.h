...
#define NETSNMP_CONFIGURE_OPTIONS " '--with-cc=mips-linux-uclibc-gcc' '--with-linkcc=mips-linux-uclibc-gcc' '--with-ar=mips-linux-uclibc-ar' '--host=mips-linux-uclibc' '--target=mips-linux-uclibc' '--with-default-snmp-version=2' '--enable-ipv6' '--disable-debugging' '--without-kmem-usage' '--disable-manuals' '--without-perl-modules' '--disable-embedded-perl' '--with-out-mib-modules=ucd_snmp disman/event disman/schedule host agent agentx hardware' '--with-mib-modules=etherlike-mib Rmon' 'host_alias=mips-linux-uclibc' 'target_alias=mips-linux-uclibc'"
...
#define NETSNMP_DEFAULT_MIBS ":EtherLike-MIB:RMON-MIB:SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:SNMP-TARGET-MIB:NET-SNMP-AGENT-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-FRAMEWORK-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IPV6-ICMP-MIB:IPV6-MIB:IPV6-TCP-MIB:IPV6-UDP-MIB:IP-FORWARD-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:NET-SNMP-VACM-MIB"
