...
sa_find_next(void)
{
    ...
    struct timeval  t_now_tmp;
    struct alarm_timeval t_now;

    gettimeofday(&t_now_tmp, NULL);

    t_now.tv_sec = (unsigned int) t_now_tmp.tv_sec;
    t_now.tv_usec = (unsigned int) t_now_tmp.tv_usec;
