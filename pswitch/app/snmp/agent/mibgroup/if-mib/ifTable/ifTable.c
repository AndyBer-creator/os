...
init_ifTable(void)
{
    ...
    //snmp_log(LOG_DEBUG, "init_ifTable init \n");
...
#ifdef CONFIG_SYS_MIB_INTERFACE_GROUP
...
ifType_get(ifTable_rowreq_ctx * rowreq_ctx, u_long * ifType_val_ptr)
{
   ...
   // (*ifType_val_ptr) = rowreq_ctx->data.ifType;
    if (IS_TRKLP(PORTID))
     (*ifType_val_ptr) = IANAIFTYPE_IEEE8023ADLAG;
    else
    (*ifType_val_ptr) = IANAIFTYPE_ETHERNETCSMACD;
...
ifMtu_get(ifTable_rowreq_ctx * rowreq_ctx, long *ifMtu_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    netsnmp_assert(NULL != rowreq_ctx);
        ...
        sal_switch_maxFrameSize_get(&mtu);
        if (0 == mtu)
            mtu = DFLT_PORT_MAX_FRAME_SIZE;
#else
         mtu = 1522;
#endif
...
ifSpeed_get(ifTable_rowreq_ctx * rowreq_ctx, u_long * ifSpeed_val_ptr)
{
    ...
    const uint32 portTypeVal[] = {SYS_PORT_VAL_100M, SYS_PORT_VAL_1000M,0, SYS_PORT_VAL_100M,SYS_PORT_VAL_1000M}; // mapping sys_port_type_t
    const uint32 portAbVal[] = {SYS_PORT_VAL_10M, SYS_PORT_VAL_100M, SYS_PORT_VAL_1000M, SYS_PORT_VAL_100M, 0} ; //mapping sys_port_speedAbility_t
                  ...
                  size_t * ifPhysAddress_val_ptr_len_ptr)
{
   /** we should have a non-NULL pointer and enough storage */
    ...
    rsd_sys_portMacAddr_get(PORTID, *ifPhysAddress_val_ptr_ptr);
    *ifPhysAddress_val_ptr_len_ptr = ETHER_ADDR_LEN;
                  ...
                  u_long * ifAdminStatus_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    if (isTesting)
        admin_status = IFADMINSTATUS_TESTING;
    else
    {
        sal_port_enable_get(PORTID, &enable);
        if (ENABLED == enable)
            admin_status = IFADMINSTATUS_UP;
        else
            admin_status = IFADMINSTATUS_DOWN;
    }
 //   (*ifAdminStatus_val_ptr) = rowreq_ctx->data.ifAdminStatus;
       (*ifAdminStatus_val_ptr) =  admin_status;
                 ...
                 u_long * ifOperStatus_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    if (PORT_LINKUP == linkStatus)
            oper_status = IFOPERSTATUS_UP;
        else
            oper_status = IFOPERSTATUS_DOWN;

    if (PORTID > NORMAL_LOGIC_PORT_END)
    {
        LOGIC_PORTMASK_CLEAR_ALL(trunkMbr);
        LP2TRKMBRLPM(PORTID, &trunkMbr);
        if (IS_LOGIC_PORTMASK_CLEAR(trunkMbr))
            oper_status = IFOPERSTATUS_NOTPRESENT;
    }

    (*ifOperStatus_val_ptr) = oper_status;
                 ...
                 u_long * ifLastChange_val_ptr)
{
    ...
    *ifLastChange_val_ptr =  (u_long)changeTime;
               ...
               u_long * ifInOctets_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    sal_mib_ifInOctets_get(PORTID, &cntr64);
    (*ifInOctets_val_ptr) = (u_long) cntr64;
                  ...
                  u_long * ifInUcastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    sal_mib_ifInUcastPkts_get( PORTID, &cntr64);
      //  (*ifInUcastPkts_val_ptr) = rowreq_ctx->data.ifInUcastPkts;
    (*ifInUcastPkts_val_ptr) = (ulong)cntr64;
                   ...
                   u_long * ifInNUcastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    sal_mib_ifInNUcastPkts_get(PORTID, &cntr64);

    (*ifInNUcastPkts_val_ptr) = (u_long)cntr64;
    return MFD_SUCCESS;
}                               /* ifInNUcastPkts_get */
                 ...
                 u_long * ifInDiscards_val_ptr)
{
   ...
   // (*ifInDiscards_val_ptr) = rowreq_ctx->data.ifInDiscards;
    sal_mib_ifInDiscards_get(PORTID, &cntr64);
        (*ifInDiscards_val_ptr) = (u_long) cntr64;
    return MFD_SUCCESS;
}                               /* ifInDiscards_get */
               ...
               u_long * ifInErrors_val_ptr)
{
   ...
   // (*ifInErrors_val_ptr) = rowreq_ctx->data.ifInErrors;
     sal_mib_ifInErrors_get(PORTID, &cntr64);
     (*ifInErrors_val_ptr) = (u_long) cntr64;
    return MFD_SUCCESS;
}                               /* ifInErrors_get */
                ...
                u_long * ifOutOctets_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    //(*ifOutOctets_val_ptr) = rowreq_ctx->data.ifOutOctets;
     sal_mib_ifOutOctets_get(PORTID, &cntr64);
        (*ifOutOctets_val_ptr) = (u_long) cntr64;
    return MFD_SUCCESS;
}                               /* ifOutOctets_get */
                   ...
                   u_long * ifOutUcastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    //(*ifOutUcastPkts_val_ptr) = rowreq_ctx->data.ifOutUcastPkts;
     sal_mib_ifOutUcastPkts_get(PORTID, &cntr64);
    (*ifOutUcastPkts_val_ptr) = (u_long)cntr64;
                    ...
                    u_long * ifOutNUcastPkts_val_ptr)
{
   ...
   // (*ifOutNUcastPkts_val_ptr) = rowreq_ctx->data.ifOutNUcastPkts;
    sal_mib_ifOutNUcastPkts_get(PORTID, &cntr64);
        (*ifOutNUcastPkts_val_ptr) = (u_long) cntr64;
    return MFD_SUCCESS;
}                               /* ifOutNUcastPkts_get */
                  ...
                  u_long * ifOutDiscards_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    //(*ifOutDiscards_val_ptr) = rowreq_ctx->data.ifOutDiscards;
     sal_mib_ifOutDiscards_get(PORTID, &cntr64);
    (*ifOutDiscards_val_ptr) = (u_long)cntr64;
                ...
                u_long * ifOutErrors_val_ptr)
{
   ...
   sal_mib_ifOutErrors_get(PORTID, &cntr64);

    (*ifOutErrors_val_ptr) = (u_long)(cntr64);
...
ifOutQLen_get(ifTable_rowreq_ctx * rowreq_ctx, u_long * ifOutQLen_val_ptr)
{
   ...
   // (*ifOutQLen_val_ptr) = rowreq_ctx->data.ifOutQLen;
    ...
    sal_mib_ifOutQLen_get(PORTID, &cntr64);
    (*ifOutQLen_val_ptr) = (u_long)(cntr64);
...
{
    sys_port_media_t portMedia = PORT_MEDIA_COPPER;
     ...
     */
    if (ifAdminStatus_val > IFADMINSTATUS_TESTING || ifAdminStatus_val < IFADMINSTATUS_UP)
       return MFD_NOT_VALID_EVER;

    if (IFADMINSTATUS_TESTING == ifAdminStatus_val)
    {
        sal_port_media_get(PORTID, &portMedia);
                  ...
                  u_long ifAdminStatus_val)
{
    ...
    if(IFADMINSTATUS_DOWN == ifAdminStatus_val)
        enable = DISABLED;
    else if(IFADMINSTATUS_UP == ifAdminStatus_val)
        enable = ENABLED;
    else if (IFADMINSTATUS_TESTING == ifAdminStatus_val)
    {
        sal_port_media_get(PORTID, &portMedia);
        if(PORT_MEDIA_FIBER != portMedia)
        {
            isTesting = TRUE;
            sal_cablediag_copper_set(PORTID);
            isTesting = FALSE;
        }
    }

    if (ifAdminStatus_val <  IFADMINSTATUS_TESTING)
        SYS_SNMP_ERR_CHK(sal_port_enable_set(PORTID, enable), SNMP_ERR_RESOURCEUNAVAILABLE);
