...
#define PORTID  (UP2LP(rowreq_ctx->tbl_idx.ifIndex))

#define LOW32BIT_GET(value)    (value & 0xffffffff)
#define HIGH32BIT_GET(value)  ((value >> 32) & 0x0ffffffff)
                      ...
                      u_long * ifInMulticastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    sal_mib_ifInMulticastPkts_get(PORTID, &cntr64);
    (*ifInMulticastPkts_val_ptr) = (u_long)cntr64;
    return MFD_SUCCESS;
                      ...
                      u_long * ifInBroadcastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    //(*ifInBroadcastPkts_val_ptr) = rowreq_ctx->data.ifInBroadcastPkts;
     sal_mib_ifInBroadcastPkts_get(PORTID, &cntr64);
    (*ifInBroadcastPkts_val_ptr) = (u_long)cntr64;
                       ...
                       u_long * ifOutMulticastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    //(*ifOutMulticastPkts_val_ptr) = rowreq_ctx->data.ifOutMulticastPkts;
     sal_mib_ifOutMcastPkts_get(PORTID, &cntr64);
    (*ifOutMulticastPkts_val_ptr) = (u_long)cntr64;
                       ...
                       u_long * ifOutBroadcastPkts_val_ptr)
{
  ...
  //  (*ifOutBroadcastPkts_val_ptr) = rowreq_ctx->data.ifOutBroadcastPkts;
     sal_mib_ifOutBcastPkts_get(PORTID, &cntr64);
    (*ifOutBroadcastPkts_val_ptr) = (u_long)cntr64;
                 ...
                 U64 * ifHCInOctets_val_ptr)
{
   ...
   sal_mib_ifHCInOctets_get(PORTID, &cntr64);
   (*ifHCInOctets_val_ptr).high = HIGH32BIT_GET(cntr64);
   (*ifHCInOctets_val_ptr).low =  LOW32BIT_GET(cntr64);
                    ...
                    U64 * ifHCInUcastPkts_val_ptr)
{
   ...
   sal_mib_ifHCInUcastPkts_get(PORTID, &cntr64);
   (*ifHCInUcastPkts_val_ptr).high = HIGH32BIT_GET(cntr64);
   (*ifHCInUcastPkts_val_ptr).low =  LOW32BIT_GET(cntr64);
                        ...
                        U64 * ifHCInMulticastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    sal_mib_ifHCInMulticastPkts_get(PORTID, &cntr64);

    (*ifHCInMulticastPkts_val_ptr).high = HIGH32BIT_GET(cntr64);
    (*ifHCInMulticastPkts_val_ptr).low = LOW32BIT_GET(cntr64);
...
//    (*ifHCInBroadcastPkts_val_ptr).low = rowreq_ctx->data.ifHCInBroadcastPkts.low;
    ...
    sal_mib_ifHCInBroadcastPkts_get(PORTID, &cntr64);
    (*ifHCInBroadcastPkts_val_ptr).high = HIGH32BIT_GET(cntr64);
    (*ifHCInBroadcastPkts_val_ptr).low = LOW32BIT_GET(cntr64);
...
//    (*ifHCOutOctets_val_ptr).low = rowreq_ctx->data.ifHCOutOctets.low;
   sal_mib_ifHCOutOctets_get(PORTID, &cntr64);
   (*ifHCOutOctets_val_ptr).high = HIGH32BIT_GET(cntr64);
   (*ifHCOutOctets_val_ptr).low = LOW32BIT_GET(cntr64);
                     ...
                     U64 * ifHCOutUcastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    sal_mib_ifHCOutUcastPkts_get(PORTID, &cntr64);
    (*ifHCOutUcastPkts_val_ptr).high = HIGH32BIT_GET(cntr64);
    (*ifHCOutUcastPkts_val_ptr).low = LOW32BIT_GET(cntr64);
                         ...
                         U64 * ifHCOutMulticastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
     sal_mib_ifHCOutMcastPkts_get(PORTID, &cntr64);

    (*ifHCOutMulticastPkts_val_ptr).high =  HIGH32BIT_GET(cntr64);
    (*ifHCOutMulticastPkts_val_ptr).low = LOW32BIT_GET(cntr64);
                         ...
                         U64 * ifHCOutBroadcastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    sal_mib_ifHCOutBcastPkts_get(PORTID, &cntr64);
    (*ifHCOutBroadcastPkts_val_ptr).high = HIGH32BIT_GET(cntr64);
    (*ifHCOutBroadcastPkts_val_ptr).low = LOW32BIT_GET(cntr64);
                           ...
                           u_long * ifLinkUpDownTrapEnable_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    sal_snmp_trapEnable_get(SNMP_TRAP_CLASS_LINKUPDOWN, &enable);
#endif
    if(DISABLED == enable)
        (*ifLinkUpDownTrapEnable_val_ptr) = 2; /*disable*/
    else if(ENABLED == enable)
        (*ifLinkUpDownTrapEnable_val_ptr) = 1;
                ...
                u_long * ifHighSpeed_val_ptr)
{
    ...
    const uint32 portTypeVal[] = {100, 1000,10000,0, 100,1000}; // mapping sys_port_type_t
    const uint32 portAbVal[] = {10, 100, 1000, 100, 10000,0} ; //mapping sys_port_speedAbility_t
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    sal_port_linkStatus_get(PORTID, &linkStatus);

    if (PORT_LINKUP == linkStatus)
    {
        sal_port_speedDuplex_get(PORTID, &speedDuplex);
        if (PORT_SPEED_10M == speedDuplex.speed)
            speed = (SYS_PORT_VAL_10M/SYS_PORT_VAL_1M);
        else if(PORT_SPEED_100M == speedDuplex.speed)
            speed = (SYS_PORT_VAL_100M/SYS_PORT_VAL_1M);
        else if(PORT_SPEED_1000M == speedDuplex.speed)
            speed = (SYS_PORT_VAL_1000M/SYS_PORT_VAL_1M);
        else if(PORT_SPEED_2_5G == speedDuplex.speed)
            speed = ((SYS_PORT_VAL_1000M/SYS_PORT_VAL_1M)*2) + ((SYS_PORT_VAL_100M/SYS_PORT_VAL_1M)*5);
        else if(PORT_SPEED_10G == speedDuplex.speed)
            speed = (SYS_PORT_VAL_1000M/SYS_PORT_VAL_1M)*10;
    }
    else
    {
        SYS_MEM_CLEAR(portSpeed);
        sal_port_speed_get(PORTID, &portSpeed);
        if (SYS_PORT_SPEED_ALL == portSpeed.ability)
        {
            speed = portTypeVal[LP2TYPE(PORTID)];
        }
        else
        {
            speed = portAbVal[portSpeed.ability];
        }
    }

     (*ifHighSpeed_val_ptr) = speed;
...
#endif
    (*ifPromiscuousMode_val_ptr) = 1; /*switch alway true*/
    return MFD_SUCCESS;
            ...
            size_t * ifAlias_val_ptr_len_ptr)
{
    ...
    int32 ret = MFD_RESOURCE_UNAVAILABLE;
    SYS_MEM_CLEAR(descp);
   ...
   /** we should have a non-NULL pointer and enough storage */
    ...
    ret = sal_port_descp_get(PORTID, descp);

    if (SYS_ERR_OK != ret)
        return MFD_RESOURCE_UNAVAILABLE;

    (*ifAlias_val_ptr_len_ptr) = osal_strlen(descp);
    memcpy((*ifAlias_val_ptr_ptr), descp, (*ifAlias_val_ptr_len_ptr));
/*
    (*ifAlias_val_ptr_len_ptr) =
...
{
    sys_port_linkChangeTime_t changeTime = 0;
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    sal_port_linkChangeTime_get(PORTID, &changeTime);
    changeTime = changeTime/10;
    *ifCounterDiscontinuityTime_val_ptr =  (u_long)changeTime;
    return MFD_SUCCESS;
                                   ...
                                   u_long ifLinkUpDownTrapEnable_val)
{
     ...
     */
    if (IS_LOGIC_PORT_INVALID(PORTID))
        return MFD_CANNOT_CREATE_NOW;

    /*0 : DISABLE; 1:ENABLE*/
    if(ifLinkUpDownTrapEnable_val < 0 || ifLinkUpDownTrapEnable_val > 2)
        return MFD_CANNOT_CREATE_NOW;
                           ...
                           u_long ifLinkUpDownTrapEnable_val)
{
     ...
     */
     if (1 == ifLinkUpDownTrapEnable_val)
        enable = ENABLED;

#ifdef CONFIG_SYS_MIB_TRAP
   // rowreq_ctx->data.ifLinkUpDownTrapEnable = ifLinkUpDownTrapEnable_val;
    SYS_SNMP_ERR_CHK(sal_snmp_trapEnable_set(SNMP_TRAP_CLASS_LINKUPDOWN, enable), SNMP_ERR_RESOURCEUNAVAILABLE);
#endif

    //rowreq_ctx->data.ifentry->linkTrapStatus =  ifLinkUpDownTrapEnable_val;
    return MFD_SUCCESS;
                    ...
                    char *ifAlias_val_ptr, size_t ifAlias_val_ptr_len)
{
     ...
     */
    ret = sal_util_string_chk(ifAlias_val_ptr, FALSE, FALSE, TRUE);
    if (SYS_ERR_OK != ret)
        return MFD_NOT_VALID_EVER;
            ...
            size_t ifAlias_val_ptr_len)
{
     ...
     */
    ret = sal_port_descp_set(PORTID, ifAlias_val_ptr);
    rowreq_ctx->data.ifAlias_len = osal_strlen(ifAlias_val_ptr);
