...
extern int rip_interface_address_delete (int , struct zclient *, zebra_size_t,
    vrf_id_t);
extern int ripEnableNwInfoGet(DATA_OP_ENT op, RIP_ENABLE_NW_INFO_T *pRipEnableNwInfo);
extern int frrRipEnableNwInfoGet(DATA_OP_ENT op, RIP_ENABLE_NW_INFO_T *pRipEnableNwInfo);
