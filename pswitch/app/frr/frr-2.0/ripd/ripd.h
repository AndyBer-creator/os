...
extern int rip_enable (void);
extern int rip_disable (void);
extern int ripNetworkSet(int bNoFlag, u_int32_t ulIp, u_int32_t ulMask, char *ifname);
extern int ripVersionSet(int bNoFlag, int version);
extern int ripStaticRouteSet(int bNoFlag,char * szRoute);
extern int ripDistanceSet(int bNoFlag, int distance);
extern int ripDistanceSourceSet(int bNoFlag, const char *distance_str, const char *ip_str);
extern int frrLogStdoutSet(int isEnbale);
extern int frrLogFileNameSet(int isEnbale);
extern int ripdFrrStatusGet(int *bEnable);
extern int frrRipVersionGet(int *sendVersion, int *recvVersion);
extern int frrRipIpRouteGet(DATA_OP_ENT op, RIP_IP_ROUTE_STRC *pRipRoute);
extern int frrRipRouteNumGet(int *pulCnt);
extern int frrRipInfoGet(RIP_INFO_T *pRipInfo);
