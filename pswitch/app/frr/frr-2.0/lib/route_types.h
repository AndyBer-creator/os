...
#define ZEBRA_ROUTE_TABLE                13
#define ZEBRA_ROUTE_LDP                  14
#define ZEBRA_ROUTE_VNC                  15
#define ZEBRA_ROUTE_VNC_DIRECT           16
#define ZEBRA_ROUTE_VNC_DIRECT_RH        17
#define ZEBRA_ROUTE_BGP_DIRECT           18
#define ZEBRA_ROUTE_BGP_DIRECT_EXT       19
#define ZEBRA_ROUTE_ALL                  20
#define ZEBRA_ROUTE_MAX                  21

#define SHOW_ROUTE_V4_HEADER \
  "Codes: K - kernel route, C - connected, S - static, R - RIP,%s" \
  "       O - OSPF, I - IS-IS, B - BGP, P - PIM, T - Table, v - VNC,%s" \
  "       V - VNC-Direct,%s" \
  "       > - selected route, * - FIB route%s%s", \
  VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE
#define SHOW_ROUTE_V6_HEADER \
  "Codes: K - kernel route, C - connected, S - static, R - RIPng,%s" \
  "       O - OSPFv6, I - IS-IS, B - BGP, T - Table, v - VNC,%s" \
  "       V - VNC-Direct,%s" \
  "       > - selected route, * - FIB route%s%s", \
  VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE, VTY_NEWLINE
...
#define FRR_REDIST_STR_BGPD \
  "(kernel|connected|static|rip|ripng|ospf|ospf6|isis|pim|table|vnc|vnc-direct)"
...
#define FRR_IP_REDIST_STR_BGPD \
  "(kernel|connected|static|rip|ospf|isis|pim|table|vnc|vnc-direct)"
...
#define FRR_IP6_REDIST_STR_BGPD \
  "(kernel|connected|static|ripng|ospf6|isis|table|vnc|vnc-direct)"
...
#define FRR_REDIST_STR_ISISD \
  "(kernel|connected|static|rip|ripng|ospf|ospf6|bgp|pim|table|vnc)"
...
#define FRR_IP_REDIST_STR_ISISD \
  "(kernel|connected|static|rip|ospf|bgp|pim|table|vnc)"
...
#define FRR_IP6_REDIST_STR_ISISD \
  "(kernel|connected|static|ripng|ospf6|bgp|table|vnc)"
...
#define FRR_REDIST_STR_OSPF6D \
  "(kernel|connected|static|ripng|isis|bgp|table|vnc)"
...
#define FRR_REDIST_STR_OSPFD \
  "(kernel|connected|static|rip|isis|bgp|pim|table|vnc)"
...
#define FRR_REDIST_STR_PIMD \
  "(kernel|connected|static|rip|ospf|isis|bgp|table|vnc)"
...
#define FRR_REDIST_STR_RIPD \
  "(kernel|connected|static|ospf|isis|bgp|pim|table|vnc)"
...
#define FRR_REDIST_STR_RIPNGD \
  "(kernel|connected|static|ospf6|isis|bgp|table|vnc)"
...
#define FRR_IP_PROTOCOL_MAP_STR_ZEBRA \
  "(kernel|connected|static|rip|ospf|isis|bgp|pim|table|vnc|any)"
...
#define FRR_IP6_PROTOCOL_MAP_STR_ZEBRA \
  "(kernel|connected|static|ripng|ospf6|isis|bgp|table|vnc|any)"
