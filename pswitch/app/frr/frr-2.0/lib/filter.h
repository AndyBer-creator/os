...
extern int rip_frr_access_list_zebra_set (int set, int afi,char *name_str, char *type_str, char *prefix_str, int exact);
extern int access_list_get_alist_info( DATA_OP_ENT op, int afi, ALIST_INFO_T *pAlistInfo);
extern int access_list_get_filter_info(DATA_OP_ENT op, int afi, FILTER_INFO_T *pFilterInfo);
