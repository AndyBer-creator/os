...
extern int rip_frr_distribute_list_set(int isNoFlag, const char *alist_name, const char *type, const char *ifname);
extern int frr_distribute_info_get(DATA_OP_ENT op,  DISTRIBUTE_INFO_T *pDistribute);
