...
extern int zebraIfShutdown(int *ifname, BOOL bShutdown) ;
extern int zebraIfIpAddressAdd(char *ifname, char *addr_str);
extern int zebraIfIpAddressDelete(char *ifname, char *addr_str);
