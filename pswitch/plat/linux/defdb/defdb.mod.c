...
__attribute__((section("__versions"))) = {
	...
	{ 0x5fa7cff3, __VMLINUX_SYMBOL_STR(__register_chrdev) },
	{ 0xe4296699, __VMLINUX_SYMBOL_STR(_page_cachable_default) },
	...
	{ 0x81b237d7, __VMLINUX_SYMBOL_STR(vmalloc_to_page) },
};
