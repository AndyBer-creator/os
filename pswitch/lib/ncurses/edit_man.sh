...
*.[0-9]*)
	...
	if test ! -f man_alias.sed ; then
cat >>man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
CF_EOF2
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f man_alias.sed | sort -u`
