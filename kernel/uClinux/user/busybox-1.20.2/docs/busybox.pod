...
Currently available applets include:
	...
	[, [[, arp, ash, basename, bunzip2, bzcat, bzip2, cat, chmod, chown,
	clear, cp, cttyhack, date, dd, depmod, df, dmesg, dnsdomainname,
	echo, false, fdisk, free, halt, hd, hexdump, hostname, ifconfig,
	init, insmod, kill, killall, killall5, klogd, less, linuxrc, ln, ls,
	lsmod, mesg, mkdir, mkfifo, mknod, modinfo, modprobe, more, mount,
	mv, netstat, ping, ping6, pkill, poweroff, ps, pwd, reboot, reset,
	rm, rmdir, rmmod, route, sh, stty, syslogd, tail, tar, telnet, test,
	tftp, top, touch, traceroute, true, tty, umount, uname, uptime,
	watch, wc, yes
...
tar -[cxtjhmvO] [-X FILE] [-T FILE] [-f TARFILE] [-C DIR] [FILE]...
